  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Requirement: Modal content must scroll on small viewports without pushing close button off-screen
             Approach: Scrollable content area with fixed header/button, max-h-[85vh] on dialog
             Alternatives considered:
